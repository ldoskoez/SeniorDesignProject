...
import PdollarComponent from '../components/pdollar-box/pdollar-box.jsx';
...
class Pdollarbox extends React.Component {
    constructor (props) {
        super(props);
        bindAll(this, [
            'attachMouseEvents',
